package net.jjjshop.shop.service.export.impl;
...
public class ExportServiceImpl implements ExportService {
     ...
     * @return
     */
    public void orderListTo(List<OrderVo> orderList, HttpServletResponse httpServletResponse) throws UnsupportedEncodingException {
        //转换为导出对象
        List<OrderExportVo> list = orderList.stream().map(e -> {
            ...
            if (e.getAddress() != null) {
                ...
                vo.setDetailRegion(province + city + region + e.getAddress().getAddress());
            }
        ...
        writer.addHeaderAlias("pointsMoney", "积分抵扣");
     ...
     */
    @Override
    public String filterProductInfo(OrderVo orderVo) {
        StringBuilder str = new StringBuilder();
        orderVo.getProduct().stream().forEach(e -> {
            Iterator<OrderProductVo> iterator = orderVo.getProduct().listIterator();
