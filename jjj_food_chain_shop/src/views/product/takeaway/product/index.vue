  ...
  <div class="product-list">
      ...
      <el-tabs v-model="activeName" @tab-change="handleClick">
        ...
        <el-tab-pane label="下架" name="lower">
          <template #label>
            <span>
              下架
              <el-tag size="small">{{ product_count.lower }}</el-tag>
            </span>
          </template>
        </el-tab-pane>
      </el-tabs>
    ...
    <div class="common-level-rail">
      <el-button
        ...
        type="primary"
        icon="Plus"
        v-auth="'/product/takeaway/product/add'"
        @click="addClick"
        >添加产品</el-button
      >
    </div>
          ...
          <el-table-column fixed="right" label="操作" width="160">
            <template #default="scope">
              <el-button
                ...
                type="text"
                size="small"
                v-auth="'/product/takeaway/product/edit'"
                >编辑</el-button
              >
              <el-button
                ...
                type="text"
                size="small"
                v-auth="'/product/takeaway/product/state'"
                v-if="scope.row.productStatus != 20"
                >下架</el-button
              >
              <el-button
              ...
              <el-button
                ...
                type="text"
                size="small"
                v-auth="'/product/takeaway/product/delete'"
                >删除</el-button
              >
            </template>
          </el-table-column>
