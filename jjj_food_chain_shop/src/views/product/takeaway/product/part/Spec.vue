<template>
  <div>
    ...
    <!--    <el-form-item label="最小购买量：" :rules="[{ required: true, message: '请填写最小购买量' }]" prop="model.min_buy">
      <el-input type="number" v-model="form.model.min_buy" class="max-w460"></el-input>
    </el-form-item> -->
