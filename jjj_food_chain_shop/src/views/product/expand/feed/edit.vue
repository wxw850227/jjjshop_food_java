<template>
  ...
  <el-dialog title="添加加料" v-model="dialogVisible" @close="dialogFormVisible" :close-on-click-modal="false"
    ...
    <el-form size="small" :model="form" :rules="formRules" ref="form">
      ...
      <el-form-item label="加料名称" prop="feedName" :label-width="formLabelWidth">
        <el-input type="text" v-model="form.feedName"></el-input>
      </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.form.feedId = this.editform.feedId;
      this.form.feedName = this.editform.feedName;
