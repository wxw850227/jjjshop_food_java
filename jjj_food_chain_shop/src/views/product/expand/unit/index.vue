    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading"
          ...
          <el-table-column prop="unitId" label="ID"></el-table-column>
          <el-table-column prop="unitName" label="单位名称" width="400px"></el-table-column>
          <el-table-column fixed="right" label="操作" width="120">
            <template #default="scope">
              <el-button @click="editClick(scope.row)" type="text" size="small" v-auth="'/product/expand/unit/edit'">编辑
              </el-button>
              <el-button @click="deleteClick(scope.row.unitId)" type="text" size="small"
