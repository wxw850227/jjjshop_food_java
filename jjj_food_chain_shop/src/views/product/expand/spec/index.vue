    ...
    <div class="product-content">
      <div class="table-wrap">
        <el-table size="small" :data="tableData" border style="width: 100%" v-loading="loading"
          ...
          <el-table-column prop="specId" label="ID"></el-table-column>
          <el-table-column prop="specName" label="规格名" width="400px"></el-table-column>
          <el-table-column fixed="right" label="操作" width="120">
            <template  #default="scope">
              <el-button @click="editClick(scope.row)" type="text" size="small" v-auth="'/product/expand/spec/edit'">编辑
              </el-button>
              <el-button @click="deleteClick(scope.row.specId)" type="text" size="small"
