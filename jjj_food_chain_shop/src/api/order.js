...
let OrderApi = {
    ...
    takeOrderlist(data, errorback) {
        return request._postBody('/shop/takeout/order/index', data, errorback);
    },
    storeOrderlist(data, errorback) {
        return request._postBody('/shop/store/order/index', data, errorback);
    },
    /*订单详情*/
    ...
    storeConfirm(data, errorback) {
        return request._postBody('/shop/store/operate/orderCancel', data, errorback);
    },
    takeConfirm(data, errorback) {
        return request._postBody('/shop/takeout/operate/orderCancel', data, errorback);
    },
    /*退款*/
    takeRefund(data, errorback) {
        return request._postBody('/shop/takeout/operate/refund', data, errorback);
    },
    storeRefund(data, errorback) {
        return request._postBody('/shop/store/operate/refund', data, errorback);
    },
    /*确认收货并退款*/
    ...
    takeExtract(data, errorback) {
        return request._postBody('/shop/takeout/operate/extract', data, errorback);
    },
    storeExtract(data, errorback) {
        return request._postBody('/shop/store/operate/extract', data, errorback);
    },
    sendDada(data, errorback) {
        return request._postBody('/shop/takeout/operate/sendOrder', data, errorback);
    },
