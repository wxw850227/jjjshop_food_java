...
let StoreApi = {
  ...
  addTable(data, errorback) {
    return request._postBody('/shop/store/table/table/add', data, errorback);
  },
  /*编辑桌位*/
  editTable(data, errorback) {
    return request._postBody('/shop/store/table/table/edit', data, errorback);
  },
  /*删除桌位*/
  ...
  addArea(data, errorback) {
    return request._postBody('/shop/store/table/area/add', data, errorback);
  },
  /*编辑区域*/
  editArea(data, errorback) {
    return request._postBody('/shop/store/table/area/edit', data, errorback);
  },
  /*删除区域*/
  ...
  addType(data, errorback) {
    return request._postBody('/shop/store/table/type/add', data, errorback);
  },
  /*编辑类型*/
  editType(data, errorback) {
    return request._postBody('/shop/store/table/type/edit', data, errorback);
  },
  /*删除类型*/
  ...
  storeSurvey(data, errorback) {
    return request._postBody('/shop/store/survey/index', data, errorback);
  },
}
