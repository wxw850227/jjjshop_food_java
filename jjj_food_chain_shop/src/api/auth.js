...
let AuthApi = {
  ...
  roleAdd(data, errorback) {
    return request._postBody('/shop/auth/role/add', data, errorback);
  },
  /*修改角色需要的数据*/
  ...
  roleEdit(data, errorback) {
    return request._postBody('/shop/auth/role/edit', data, errorback);
  },
  /*删除角色*/
  ...
  userList(data, errorback) {
    return request._postBody('/shop/auth/user/index', data, errorback);
  },
  /*添加管理员需要的数据*/
  ...
  userAdd(data, errorback) {
    return request._postBody('/shop/auth/user/add', data, errorback);
  },
  /*修改管理员需要的数据*/
  ...
  userEdit(data, errorback) {
    return request._postBody('/shop/auth/user/edit', data, errorback);
  },
  /*删除管理员*/
  ...
  loginlog(data, errorback) {
    return request._postBody('/shop/auth/loginlog/index', data, errorback);
  },
  /*操作日志*/
  optlog(data, errorback) {
    return request._postBody('/shop/auth/optlog/index', data, errorback);
  },
  /*操作日志*/
  setStatus(data, errorback) {
    return request._postBody('/shop/auth/user/setStatus', data, errorback);
  }
}
