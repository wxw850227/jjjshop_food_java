	...
	<view class="login-container"  :style="'height: '+phoneHeight+'px;'">
		<view class="p-30-75" v-if="isLogin==2">
			<view class="login_topbpx">
				...
				<view class="login_top">已有账户，<text class="red" @click="isLogin=1">立即登录</text></view>
			</view>
			<view class="group-bd">
		...
		<view class="p-30-75" v-if="isLogin==1">
			<view class="login_topbpx">
				...
				<view class="login_top">还没有账号，<text class="red" @click="isLogin=2">立即注册</text></view>
			</view>
			<view class="group-bd">
				<view class="form-level d-s-c">
		...
		<view class="p-30-75" v-if="isLogin==0">
			<view class="login_topbpx">
				...
				<view class="login_top"><text class="red" @click="isLogin=1">立即登录</text></view>
			</view>
			<view class="group-bd">
				<view class="form-level d-s-c">
		...
		<view v-if="isLogin==1" class=" gray6 p-0-75" :class="is_code?'d-e-c':'d-b-c'">
			<view v-if="!is_code" @click="isLogin=0">忘记密码?</view>
			<view @click="isCode()">{{is_code?'使用密码登录':'使用验证码登录'}}</view>
		</view>

		<view style="padding-top: 80rpx;" class="btns p-30-75" v-if="isLogin==2"><button type="default" @click="registerSub">注册</button></view>
		<view style="padding-top: 80rpx;" class="btns p-30-75" v-if="isLogin==1"><button type="default" @click="formSubmit">登录</button></view>
		<view style="padding-top: 80rpx;" class="btns p-30-75" v-if="isLogin==0"><button type="default" @click="resetpasswordSub">重置密码</button></view>
		<view class="bottom_nav" v-if="isLogin==1">
